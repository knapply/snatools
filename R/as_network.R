...
#'   as_network()
#' 
#' as_igraph(sampson_monastery) %==% as_network(sampson_monastery)
#' 
#' data("davis_southern_women")
#' 
#' davis_southern_women %>% # bipartite
#'   as_network()
#'   
...
#'   as_network()
#'   
#' as_network(davis_southern_women) %==% as_igraph(davis_southern_women)
#' 
#' @export
