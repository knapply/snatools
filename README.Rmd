...
[![Depends](https://img.shields.io/badge/Depends-GNU_R%20>=%203.2-blue.svg)](https://www.r-project.org/)
...
`tibble`s are the focus as the `statnet` suite has already begun importing the `tidyverse`.
